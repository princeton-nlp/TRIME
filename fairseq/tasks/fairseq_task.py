...
class FairseqTask(object):
    ...
    def get_batch_iterator(
        ...
        epoch_iter = iterators.EpochBatchIterator(
            ...
            epoch=epoch,
            predefined_batches=(self.args.predefined_batches is not None),
            keep_order=(hasattr(self.args, 'keep_order') and self.args.keep_order),
            num_comb_shards=getattr(self.args, 'num_comb_shards', 1),
        )
