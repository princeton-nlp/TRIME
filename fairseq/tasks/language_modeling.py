...
class LanguageModelingTask(FairseqTask):
    ...
    def load_dataset(self, split, epoch=0, combine=False, **kwargs):
        ...
        self.datasets[split] = MonolingualDataset(
            ...
            shuffle=True if (hasattr(self.args, 'keep_order') and self.args.keep_order) else (True if split == "train" else (False if hasattr(self.args, 'lm_eval') and self.args.lm_eval else True)),
