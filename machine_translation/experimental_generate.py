...
def _main(args, output_file):
    ...
    if args.eval_result is not None:
        res = {'score': scorer.result_string(), 'beam': args.beam, 
               'k': models[0].decoder.knn_datastore.k, 'l': models[0].decoder.knn_datastore.lambda_value, 't': models[0].decoder.knn_datastore.temperature}
        print(res, args.eval_result)
