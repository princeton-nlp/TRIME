...
class KNN_Dstore(object):
    ...
    def setup_faiss(self, args):
        ...
        start = time.time()
        print('Loading index from {}'.format(args.dstore_filename + '/' + args.index_filename))
        index = faiss.read_index(args.dstore_filename + '/' + args.index_filename, faiss.IO_FLAG_ONDISK_SAME_DIR)
